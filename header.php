...
<!-- Mirrored from htmldemo.net/Clothi/Clothi/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Dec 2023 07:48:56 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title>Clothi Couture: Elevate Your Style, Embrace Comfort</title>
        ...
        <div class="col-12">
          <div class="header-align">
            <div class="header-align-left">
              ...
              <div class="header-navigation-area d-none d-xl-block w-100 ">
                <ul class="main-menu nav justify-content-center position-relative">
                  ...
                  <li><a href="shop-collections.php">Collections</a></li>
                  <li class=""><a href="blog.php">Our Blog</a>
                  </li>
            ...
            <div class="header-align-right">
              <div class="header-action-area">
                ...
                <div class="header-action-account d-none d-xxl-block">
                  <button class="btn-sign-up" onclick="window.location.href='login.php'">
                    Sign Up
                  </button>
                </div>
